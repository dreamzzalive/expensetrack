...
function loadLocal(){
  ...
  if(r){const s=JSON.parse(r);if(!s.income)s.income=[];if(!s.incomeCategories)s.incomeCategories=[...DEFAULT_INCOME_CATEGORIES];return s;}
  return{transactions:[],categories:[...DEFAULT_CATEGORIES],accounts:[...DEFAULT_ACCOUNTS],income:[],incomeCategories:[...DEFAULT_INCOME_CATEGORIES]};
}
