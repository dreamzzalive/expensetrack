...
function refreshActiveDetailPage(tx, type) {
  ...
  if (type === "expense") {
    if (catPage && catPage.classList.contains("active")) {
      detailCurrentCat = tx.category;
      _renderCatDetail();
    } else if (accPage && accPage.classList.contains("active")) {
      detailCurrentAcc = tx.account;
      _renderAccDetail();
    }
  } else if (type === "income") {
    if (incPage && incPage.classList.contains("active")) {
      detailCurrentInc = tx.category;
      _renderIncDetail();
    } else if (accPage && accPage.classList.contains("active")) {
      detailCurrentAcc = tx.account;
      _renderAccDetail();
